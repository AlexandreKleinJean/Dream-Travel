...
function loadMoreHotelsByDestination() {
    for (let i = nbHotelsPerView; i < nbHotelsPerView + nbhotelsPerLoad; i++) {
      if (i < allHotels.length) {
        ...
        hotelCity.textContent = hotel.cities.name;
  ...
  loadMoreButton.addEventListener('click', function() {
    console.log("LOAD HOTELS BY DESTINATION WORKS TOOOO !");
    loadMoreHotelsByDestination();
  });
