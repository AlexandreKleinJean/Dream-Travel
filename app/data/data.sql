...
(1, 'Hotel Serenity', 4, 32, 8, 150, 'g2', 'r7', 'p3', 'Experience luxury at its finest.'),
(2, 'Ocean View Resort', 2, 13, 6, 80, 'g5', 'r4', 'p9', 'Enjoy breathtaking sea panoramas.'),
(3, 'Alpine Lodge', 6, 54, 9, 120, 'g4', 'r1', 'p5', 'Cozy retreat amidst the mountains.'),
(4, 'City Lights Inn', 3, 27, 4, 70, 'g9', 'r2', 'p7', 'Affordable stay in the heart of the city.'),
(5, 'Tranquil Spa', 1, 8, 7, 200, 'g7', 'r6', 'p4', 'Unwind and rejuvenate your senses.'),
(6, 'Sunset Hotel', 5, 46, 5, 90, 'g15', 'r3', 'p10', 'Spectacular views of the setting sun.'),
(7, 'Paradise Resort', 1, 5, 3, 180, 'g20', 'r9', 'p1', 'Luxurious stay in a tropical paradise.'),
(8, 'Woodsy Lodge', 3, 28, 8, 100, 'g14', 'r5', 'p8', 'Embrace nature in a cozy ambiance.'),
(9, 'Budget Inn', 4, 39, 4, 75, 'g13', 'r8', 'p2', 'Comfortable and affordable accommodations.'),
(10, 'Urban Heights', 2, 12, 9, 95, 'g11', 'r10', 'p6', 'Stylish hotel in the heart of the city.'),
(11, 'Serene Resort', 5, 46, 6, 110, 'g8', 'r7', 'p3', 'Peaceful retreat with excellent amenities.'),
(12, 'Riverside Lodge', 1, 4, 7, 130, 'g4', 'r4', 'p9', 'Enjoy the tranquil riverside setting.'),
(13, 'Seaside Inn', 4, 34, 5, 85, 'g2', 'r1', 'p5', 'Coastal escape with stunning ocean views.'),
(14, 'Mountain Retreat', 6, 52, 9, 140, 'g6', 'r9', 'p3', 'Escape to the serene mountainside.'),
(15, 'Coastal Haven', 2, 11, 8, 160, 'g10', 'r2', 'p7', 'Relax and unwind by the beautiful coast.'),
(16, 'Country Manor', 3, 26, 7, 120, 'g12', 'r5', 'p1', 'Experience the charm of a countryside getaway.'),
(17, 'Tropical Oasis', 1, 7, 6, 180, 'g17', 'r8', 'p4', 'Indulge in paradise at our tropical resort.'),
(18, 'Historic Inn', 5, 43, 5, 100, 'g3', 'r3', 'p10', 'Step back in time at our historic inn.'),
(19, 'Beachside Resort', 2, 14, 9, 200, 'g16', 'r6', 'p2', 'Enjoy the ultimate beachfront vacation.'),
(20, 'Lakeview Lodge', 4, 37, 8, 130, 'g11', 'r10', 'p8', 'Breathtaking lake views from every room.'),
(21, 'Cityscape Hotel', 3, 29, 7, 90, 'g19', 'r1', 'p5', 'Discover the city from our modern hotel.'),
(22, 'Rustic Cabins', 6, 51, 6, 70, 'g1', 'r4', 'p9', 'Cozy cabins nestled in a peaceful forest.'),
(23, 'Secluded Hideaway', 1, 6, 9, 150, 'g18', 'r7', 'p3', 'Escape to a private retreat away from it all.'),
(24, 'Lakeside Resort', 4, 36, 8, 180, 'g13', 'r2', 'p7', 'Unwind with stunning lakeside views.'),
(25, 'Grand Plaza', 2, 10, 7, 140, 'g9', 'r5', 'p1', 'Experience luxury at its finest in the city.'),
(26, 'Island Paradise', 5, 41, 6, 160, 'g7', 'r8', 'p4', 'Discover a tropical paradise on a secluded island.'),
